...
Site de portfólio desenvolvido com HTML, CSS e JavaScript para o 1º período de Tecnologia, focado na área de Cibersegurança.
...
- Validação: Código testado e validado no Markup Validation Service (W3C).
